...
function JordanFlag() {
  return (
    <svg viewBox="0 0 28 18" className="h-32 w-52 rounded-xl shadow-xl md:h-40 md:w-64" aria-label="علم الأردن">
      <rect width="28" height="6" fill="#000000" />
      <rect y="6" width="28" height="6" fill="#ffffff" />
      <rect y="12" width="28" height="6" fill="#007A3D" />
      <polygon points="0,0 11,9 0,18" fill="#CE1126" />
      <polygon points="3.7,6.7 4.35,8.35 6.12,8.42 4.74,9.54 5.21,11.25 3.7,10.3 2.19,11.25 2.66,9.54 1.28,8.42 3.05,8.35" fill="#ffffff" />
    </svg>
  )
}
